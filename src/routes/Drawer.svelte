<script>
  import { Drawer, Button, CloseButton, Sidebar, SidebarBrand, SidebarCta, SidebarDropdownItem, SidebarDropdownWrapper, SidebarGroup, SidebarItem, SidebarWrapper, NavHamburger } from 'flowbite-svelte';
...
<NavHamburger class="md:hidden" on:click={() => (hidden2 = false)} />
<Drawer class="" transitionType="fly" {transitionParams} bind:hidden={hidden2} id="sidebar2">
